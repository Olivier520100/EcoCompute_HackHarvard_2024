    ...
    <header className="bg-green-600 text-white p-3 flex justify-between items-center shadow-md">
      <div className="flex items-center space-x-4">
        ...
        <Link href="/" className="py-1 rounded">
          <h1 className="text-2xl font-bold text-white hover:text-green-300 transition-all duration-1000">
            EcoCompute
          </h1>
        </Link>
      </div>
      <div className="flex space-x-4">  
        ...
        <Link
          ...
          className="hover:text-green-300 transition-all duration-1000"
          target="_blank"
